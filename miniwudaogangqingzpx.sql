...
-- ----------------------------
INSERT INTO `lr_guanggao` VALUES ('2', '首页轮播', 'UploadFiles/adv/20170428/1493349892799121.png', '0', '0', '', '', '1');
...
INSERT INTO `lr_web` VALUES ('3', '0', '实名认证协议', null, '0', '1 、凡有一起读用户未经作者许可，在一起读书群内或用户评论系统转载作品，一起读对用户转载行为不负任何责任，但承诺接到作者投诉后，第一时间内删除该贴并对该用户进行相应处理。2 、属于评论、资料和学习性质的\"书评杂论\" 、\"文学资料\"等版面内容，一起读可进行转载或作品宣传，但不作为任何商业用途，如作者对此有异议，可以通知一起读将其删除。 3 、如有人恶意冒充网络作者向一起读投稿，并被一起读接受录入非其所有的原创作品，本站不承担任何责任，但保证接到真实作者投诉时，经验证后第一时间内删除该作品及冒充者账号。4 、一起读不保证收录作品稿件的安全性，请作者自行留存原稿。5 、一起读有权将作者作品推荐给合作伙伴宣传或转载，不另行告知。6 、作者文责自负，任何作者及其发布内容的文字，不代表本站观点。', '0');
